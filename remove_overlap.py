...
# Read data
data_abs = pd.read_csv('absorption.txt', delim_whitespace=True, header=None, names=['wavelength', 'absorption'])
data_ems = pd.read_csv('emission.txt', delim_whitespace=True, header=None, names=['wavelength', 'emission'])
